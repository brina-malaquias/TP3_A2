...
using TP3_A2.Persistence;

namespace TP3_A2.Controllers
{
    ...
    public class DespesasController : ControllerBase
    {
        ...
        {
            var despesa = _context.Despesas.SingleOrDefault(r => r.DespesaId == id);
        ...
        public IActionResult Update(Guid id, Despesa input)
        {
            ...
            despesa.Update(input.Valor, input.Data, input.Observacoes);
            return NoContent();
        }
        /// <summary>
